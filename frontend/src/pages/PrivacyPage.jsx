...
const SECTIONS = [
    ...
    content: (
      <>
        <p>
          ...
          الملكي رقم م/19 وتاريخ 1443/2/9هـ) ولائحته التنفيذية.
        </p>
        <p>
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-1.5 mb-4">
          <li>الاسم الحقيقي أو الاسم المعروف (بأي صيغة يختارها المستخدم) — يُستخدم كجزء أساسي من آلية اللعبة.</li>
          <li>اسم المستخدم (username) المُختار عند التسجيل.</li>
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li><strong>التواصل:</strong> إرسال إشعارات متعلقة بالحساب والمنافسة والتحديثات الأمنية عبر النظام الداخلي.</li>
        ...
        <h3 className="font-heading font-bold text-gray-900 dark:text-white text-base mt-4 mb-2">استخدام البيانات في الذكاء الاصطناعي</h3>
        <ul className="list-disc list-inside space-y-2">
          <li>قد نستخدم بيانات اللعب المجهولة والمجمّعة (بدون بيانات شخصية محددة) لأغراض تطوير وتدريب نماذج الذكاء الاصطناعي وتحسين تجربة اللعبة.</li>
          <li>لن يتم استخدام الأسماء الحقيقية أو البيانات الشخصية المباشرة لتدريب نماذج الذكاء الاصطناعي دون موافقة صريحة من المستخدم.</li>
        </ul>
    ...
    content: (
      <>
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>قد تُستضاف البيانات على خوادم خارج المملكة العربية السعودية لأسباب تتعلق بالتكلفة والكفاءة التشغيلية.</li>
          <li>نلتزم بتطبيق الضمانات الكافية لحماية البيانات وفقاً للمادة (29) من نظام حماية البيانات الشخصية عند نقل أو تخزين البيانات خارج المملكة.</li>
          <li>نحتفظ بنسخ احتياطية من البيانات بشكل دوري. في حال توقف الخدمة، سنبذل جهداً معقولاً لإتاحة تصدير البيانات الشخصية للمستخدمين.</li>
  ...
  {
    id: 'access',
    title: 'صلاحيات الوصول إلى البيانات',
    content: (
      <>
        <p className="mb-3">
          تتبع المنصة نظام صلاحيات دقيق يحدد من يمكنه الاطلاع على بيانات المستخدمين:
        </p>
        <ul className="list-disc list-inside space-y-2">
          <li><strong>المشرفون (الإداريون):</strong> يمكنهم الاطلاع على بيانات المتسابقين ضمن منافساتهم فقط، وذلك لأغراض إدارة المنافسة وضمان النزاهة.</li>
          <li><strong>مالك المنصة:</strong> قد يطلع على قاعدة البيانات لأغراض الصيانة التقنية والامتثال القانوني فقط. لا يمكن لمالك المنصة الوصول إلى الأسماء الحقيقية للمتسابقين من خلال واجهة الإدارة العادية.</li>
          <li><strong>المتسابقون:</strong> يرون الكنيات فقط، ولا تُكشف الأسماء الحقيقية إلا وفق آليات اللعبة المحددة (الهجوم الناجح، الإفلاس، وغيرها).</li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-3">لا نبيع بياناتك الشخصية ولا نؤجّرها لأي طرف ثالث. قد نشارك بيانات محدودة في الحالات التالية:</p>
        <ul className="list-disc list-inside space-y-2">
          <li><strong>مقدمو الخدمات التقنية:</strong> شركات الاستضافة وخدمات البنية التحتية اللازمة لتشغيل المنصة، وذلك بموجب اتفاقيات معالجة بيانات تضمن مستوى حماية مكافئ.</li>
          <li><strong>أدوات التحليل:</strong> قد نستخدم أدوات تحليل تابعة لأطراف ثالثة (مثل Google Analytics) لتحسين تجربة الاستخدام وفهم أنماط التفاعل مع المنصة.</li>
          <li><strong>الإعلانات:</strong> قد نعرض إعلانات من شبكات إعلانية خارجية قد تستخدم ملفات تعريف الارتباط لتقديم إعلانات ذات صلة.</li>
          <li><strong>خدمات الدفع:</strong> عند استخدام خدمات الدفع مستقبلاً، ستتم معالجة بيانات الدفع عبر بوابة دفع مرخصة، ولن تُخزَّن بيانات البطاقات على خوادمنا.</li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-2">
          <li><strong>الكنية والهوية:</strong> كنية اللاعب مرئية لجميع المتسابقين في المنافسة، لكن الربط بين الكنية والهوية الحقيقية محمي ولا يُكشف إلا وفق آليات اللعبة (الهجوم الناجح أو الإفلاس أو آليات أخرى تحددها قواعد المنافسة).</li>
          ...
          <li><strong>المشرف:</strong> يملك المشرف صلاحية الاطلاع على جميع بيانات اللعب ضمن منافسته لأغراض الإدارة وضمان النزاهة.</li>
        </ul>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li><strong>ملفات أطراف ثالثة:</strong> قد تستخدم أدوات التحليل أو شبكات الإعلانات (في حال تفعيلها) ملفات تعريف ارتباط خاصة بها. يمكنك التحكم في هذه الملفات من خلال إعدادات المتصفح.</li>
        </ul>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li><strong>طلب حذف الحساب ذاتياً:</strong> يمكنك تقديم طلب حذف حسابك من خلال إعدادات الحساب، وسيتم مراجعته من قبل الإدارة.</li>
          <li><strong>طلب تصدير البيانات:</strong> هذه الخاصية ليست متاحة حالياً عبر الواجهة وستُضاف مستقبلاً.</li>
        </ul>
        <p className="mt-3">
          يمكنك طلب أي من هذه الحقوق عبر التواصل مع إدارة المنصة من خلال حسابك داخل النظام.
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          إذا كانت لديك أي أسئلة أو استفسارات حول سياسة الخصوصية، أو ترغب في ممارسة أي من حقوقك،
          يمكنك التواصل مع إدارة المنصة من خلال حسابك داخل النظام.
        </p>
        <p className="mt-3">
          كما يحق لك التقدم بشكاوى إلى الهيئة السعودية للبيانات والذكاء الاصطناعي (سدايا) بصفتها
          الجهة المختصة بالإشراف على تطبيق نظام حماية البيانات الشخصية.
